...
public:
	...
	Vector4<float> &operator[](int index)
	{
		return *((Vector4<float> *)(data + (index * 4)));
	}
	...
	Matrix4 Invert()
	{
		...
		inverse.Set41(
			-Get21() * Get32() * Get43() + Get21() * Get33() * Get42() + Get31() * Get22() * Get43() - Get31() * Get23() * Get42() - Get41() * Get22() * Get33() + Get41() * Get23() * Get32());
